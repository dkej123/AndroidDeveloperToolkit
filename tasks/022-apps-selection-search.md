...
- Inspect the limited task-022 ADBHelper selection-preservation comparison through
  `.claude/skills/adb-development/references/adbhelper.md`; it is not the Apps UI specification.
